...
# ACDS 16.0 211 win32 2024.04.16.11:18:53
...
# ----------------------------------------
# If sin2 is one of several IP cores in your
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/sin2_nco_ii_0_sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/sin2_nco_ii_0_cos.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sin2_nco_ii_0.v" -work nco_ii_0 -cdslib ./cds_libs/nco_ii_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/sin2.v"                                                                       
fi
